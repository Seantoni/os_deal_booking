...
export const RESTAURANTE_TEMPLATE: FieldTemplate = {
  ...
  fields: [
    ...
    { name: 'restaurantOrderMethod', type: 'select', label: '¿El pedido es por chat/whatsapp o por llamada?', options: [{ value: 'Chat/WhatsApp', label: 'Chat/WhatsApp' }, { value: 'Llamada', label: 'Llamada' }, { value: 'Ambos', label: 'Ambos' }] },
...
export const CATERING_TEMPLATE: FieldTemplate = {
  ...
  fields: [
    ...
    { name: 'cateringOrderMethod', type: 'select', label: '¿El pedido es por chat/whatsapp o por llamada?', options: [{ value: 'Chat/WhatsApp', label: 'Chat/WhatsApp' }, { value: 'Llamada', label: 'Llamada' }, { value: 'Ambos', label: 'Ambos' }] },
