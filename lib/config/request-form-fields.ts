...
export const REQUEST_FORM_STEPS: RequestFormStep[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'pricingOptions.title', label: 'Título del Producto o Servicio', type: 'text' },
      { key: 'pricingOptions.description', label: 'Restricciones o Comentarios de la Opción', type: 'textarea' },
