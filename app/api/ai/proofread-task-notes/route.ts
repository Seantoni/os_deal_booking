...
export async function POST(req: Request) {
  try {
      ...
      messages: [
        {
          role: 'system',
          content:
            'Eres un asistente en español. Corrige ortografía, gramática, puntuación y claridad del texto dictado de una tarea. Mantén el significado exacto y el tono profesional. No inventes datos, no agregues información nueva y no elimines detalles importantes.',
        },
        {
          role: 'user',
    ...
    logger.error('AI proofread-task-notes error:', error)
