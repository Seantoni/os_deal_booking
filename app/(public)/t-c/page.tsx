...
export default function TermsPage() {
  return (
    <PublicPageLayout title="Términos y Condiciones" maxWidth="max-w-4xl">
      <div className="space-y-8 text-[#1d1d1f] leading-relaxed">
        <p className="text-sm text-[#86868b] text-center -mt-4 mb-8">
        ...
        <Section title="PRIMERA. DEFINICIONES">
          ...
          <ol className="list-decimal ml-6 space-y-2">
            <li>
              <strong className="text-[#1d1d1f]">Comprobante(s):</strong> Documento físico o electrónico que contiene ofertas de descuentos en los bienes y servicios de EL OFERENTE;
            </li>
            <li>
              <strong className="text-[#1d1d1f]">Público:</strong> Personas que accedan de manera remota a través de internet a la página www.ofertasimple.com;
            </li>
            <li>
              <strong className="text-[#1d1d1f]">Comprador:</strong> Persona natural o jurídica que adquirió un comprobante en la página www.ofertasimple.com;
            </li>
            <li>
              <strong className="text-[#1d1d1f]">Periodo de compra:</strong> Días en el que los comprobantes son ofrecidos y vendidos al público por parte de OFERTASIMPLE.COM en el sitio web www.ofertasimple.com;
            </li>
            <li>
              <strong className="text-[#1d1d1f]">Oferta/s:</strong> servicio/s a través de comprobantes, los cuales serán ofrecidos y vendidos al público por parte de OFERTASIMPLE.COM;
            </li>
            <li>
              <strong className="text-[#1d1d1f]">Periodo de Redención:</strong> periodo de tiempo en la cual la Oferta/s estará disponible.
            </li>
          </ol>
        </Section>
        ...
        <Section title="SÉPTIMA. CANJES PARCIALES Y LIMITACIONES">
          ...
          <p className="pl-4 border-l-2 border-[#e84c0f]/20">
        ...
        <Section title="VIGÉSIMA QUINTA. AVISOS Y NOTIFICACIONES">
          <p>
            ...
            dirección: <a href="mailto:Avisos@ofertasimple.com" className="text-[#e84c0f] hover:text-[#c2410c] underline">Avisos@ofertasimple.com</a>
          </p>
        </Section>
        ...
        {/* Acceptance Box */}
        <div className="mt-10 rounded-xl border border-[#e84c0f]/20 bg-[#e84c0f]/5 p-5">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 mt-0.5">
              <svg className="w-5 h-5 text-[#e84c0f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="pb-6 border-b border-[#e5e5e5] last:border-0 last:pb-0">
      <h2 className="text-lg font-semibold text-[#1d1d1f] mb-3 flex items-center gap-2">
        <span className="w-1.5 h-1.5 rounded-full bg-[#e84c0f]"></span>
        {title}
      </h2>
