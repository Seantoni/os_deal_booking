...
PLAN → Create todo list with clear steps

DELEGATE → Assign tasks to specialist agents

INTEGRATE → Combine results, resolve conflicts

VERIFY → Run tests, check quality

DELIVER → Summarize changes, create PR if needed
